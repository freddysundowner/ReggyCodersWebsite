...
const fallback: ProductCard[] = [
  {
    id: 0,
    name: "Pointify POS",
    description: "The reliable point-of-sale system for growing businesses: instant sales from your phone, real-time sales and profit dashboards, stock and warehouse management, cash-flow tracking, reports, debt management, branches, barcodes, receipts and a free online store.",
    tagline: "Know exactly how much your shop made today — even when you're not there.",
    icon: "ScanBarcode",
    image: pointifyImg,
    tags: ["Retail", "Inventory", "Mobile money"],
    color: "",
  ...
  },
  {
    id: 0,
    name: "ProSuite",
    description: "The all-in-one property platform for rent collection via mobile money, arrears, tenants, land and plot sales, payment plans, hotel bookings, and a WhatsApp AI assistant for listings and viewings.",
    tagline: "Property operations, without the paperwork.",
    icon: "Home",
    image: proSuiteImg,
    tags: ["Property", "Mobile money", "Hospitality"],
    color: "",
  ...
  },
  {
    id: 0,
    name: "BankyKit",
    description: "A complete banking platform for credit unions, MFIs, savings groups and banks, with KYC, flexible loan products, mobile-money disbursement, savings, shares, deposits, dividends and double-entry accounting.",
    tagline: "Bank-grade tools for financial communities.",
    icon: "University",
    image: proSuiteImg,
    tags: ["Banking", "MFI", "Accounting"],
    color: "",
  ...
  },
  {
    id: 0,
    name: "SunPay",
    description: "Mobile payment infrastructure with one API key and endpoint, signed webhooks, a live dashboard, and collections and payouts from one account. Pay as you go at 1.5% per successful transaction.",
    tagline: "Payments infrastructure, without the integration maze.",
    icon: "CreditCard",
    image: sunpayImg,
    tags: ["Payments API", "Webhooks", "Payouts"],
    color: "",
